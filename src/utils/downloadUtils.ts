  ...
  setTimeout(() => {
    try {
      ...
      switch(fileType.toLowerCase()) {
        case 'pdf':
          // We'll use text/html for better browser compatibility with our text-based PDFs
          mimeType = 'text/html';
          extension = 'pdf';
          break;
        case 'docx':
      ...
      // Wrap content in HTML for better viewing
      const htmlContent = fileType.toLowerCase() === 'pdf' ? 
        `<!DOCTYPE html>
        <html>
        <head>
          <title>Course Overview: ${fileName}</title>
          <style>
            body { 
        ...
        <body>
          ${dummyContent}
          <div class="footer">
            Course Overview: ${fileName} | Generated by Learning Platform<br>
...
const createDummyContent = (fileName: string, fileType: string) => {
  ...
  if (fileType === 'pdf') {
    ...
    <div class="section">
      ...
      ${generateDetailedTopics(courseName).replace(/\n/g, '<br>')}
    </div>
...
export const downloadCurriculumResource = (subjectName: string) => {
  ...
  setTimeout(() => {
    try {
      ...
      <html>
      <head>
        <title>Course Overview: ${subjectName}</title>
        <style>
          body { 
            font-family: Arial, sans-serif; 
            line-height: 1.6;
      ...
      <body>
        ${dummyContent}
        <div class="footer">
          Course Overview: ${subjectName} | Generated by Learning Platform<br>
          Copyright © ${new Date().getFullYear()} Learning Platform
        </div>
      </body>
      </html>`;
