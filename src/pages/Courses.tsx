...
const allCourses = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1677442135136-760c813ba761?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80',
    category: 'AI Skills',
    level: 'Beginner' as const,
    duration: '15 hours',
    students: 1850,
  ...
  },
  {
    ...
    description: 'Discover how to leverage AI tools for content creation, data analysis, automation, and productivity enhancement.',
  ...
  },
  {
    ...
    description: 'Prepare for technical interviews with coding challenges, system design problems, and behavioral question strategies.',
